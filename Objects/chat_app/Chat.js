...
(function() {
    ...
    function loadSettings() {
        ...
        chatLogMaxSize = Settings.getValue('Chat_chatLogMaxSize', hundred);
        sendTyping = Settings.getValue('Chat_sendTyping', true);
        identifyAvatarDuration = Settings.getValue('Chat_identifyAvatarDuration', ten);
        ...
        speechBubbleDuration = Settings.getValue('Chat_speechBubbleDuration', ten);
        ...
        speechBubbleLineHeight = Settings.getValue('Chat_speechBubbleLineHeight', pointZeroFive);
    ...
    function handleTransmitChatMessage(avatarID, displayName, message, data) {
        print("receiveChat", "avatarID", avatarID, "displayName", displayName,
    ...
    function identifyAvatar(yourAvatarID) {
        ...
        // print("ADDOVERLAY lineID", lineID, "myJointPosition", JSON.stringify(myJointPosition),
        // "yourJointPosition", JSON.stringify(yourJointPosition), "lineData", JSON.stringify(lineData));

        identifierParams.timer =
            Script.setTimeout(function() {
                // print("DELETEOVERLAY lineID");
                unidentifyAvatar(yourAvatarID);
            }, identifyAvatarDuration * thousand);
    ...
    function randomAvatarName() {
        return 'Anon_' + Math.floor(Math.random() * million);
    }
        ...
        switch (command) {
            ...
            case 'help':
                ...
                logMessage('Type "/name <name>" to set your chat name, or "/name" to use your display name,' +
                    'or a random name if that is not defined.', null);
    ...
    function updateSpeechBubble() {
        ...
        print("IN UPDATE message:", speechBubbleMessage);
